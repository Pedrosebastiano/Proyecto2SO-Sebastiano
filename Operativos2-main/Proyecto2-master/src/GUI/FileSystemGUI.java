...
public class FileSystemGUI extends JFrame {
    ...
    middleTabs.addTab("Buffer", bufferPanel); 
...
private void styleButton(JButton btn, Color bg, Color fgAccent) {
    ...
    private void mostrarGraficosBuffer() {
        if (!isAdmin) {
            JOptionPane.showMessageDialog(this, "🚫 Solo el Administrador pueden ver gráficos.", "Acceso Denegado", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void mostrarEstadisticas() {
        if (!isAdmin) {
            JOptionPane.showMessageDialog(this, "🚫 Solo el Administrador pueden ver estadisticas.", "Acceso Denegado", JOptionPane.WARNING_MESSAGE);
            return;
        }
        BufferCache buffer = fileSystem.getBuffer();
    ...
    private void procesarCola() {
        ...
        Thread processThread = new Thread(() -> {
            ...
            SwingUtilities.invokeLater(() -> {
                ...
                btnProcesarCola.setText("Procesar");
    ...
    private void crearArchivo() { 
        ...
        JOptionPane.showMessageDialog(this, "✅ Proceso de I/O creado. Use 'Procesar' para ejecutar.", 
    ...
    private void borrarSistema() {
        if (!isAdmin) {
            JOptionPane.showMessageDialog(this, "🚫 Solo el Administrador puede borrar el sistema.", "Acceso Denegado", JOptionPane.WARNING_MESSAGE);
            return;
        }
