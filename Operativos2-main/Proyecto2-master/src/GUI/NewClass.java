...
public class NewClass extends JFrame {
    ...
    public NewClass() {
        ...
        // Asegúrate de que esta línea tenga 4 columnas
        infoTableModel = new DefaultTableModel(
            new String[]{"Nombre", "Bloque Inicial", "Longitud", "Color"},  // ← 4 columnas
            0
        );
...
private void styleButton(JButton btn, Color bg, Color fgAccent) {
    ...
    btn.setForeground(new Color(0x333355));
    btn.setFont(new Font("Segoe UI", Font.PLAIN, 12));
    btn.setBorder(BorderFactory.createCompoundBorder(
        BorderFactory.createLineBorder(new Color(0xD5D8F0)),
    ...
    btn.addMouseListener(new java.awt.event.MouseAdapter() {
        public void mouseEntered(java.awt.event.MouseEvent e) {
            btn.setBackground(new Color(0xE1E6FF));
        }
